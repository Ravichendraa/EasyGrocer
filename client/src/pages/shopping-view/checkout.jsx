...
function ShoppingCheckout() {
  ...
  const availableGifts = [
    { id: 1, name: "Wild Craft Bag", value: 15, image: "/images/gifts/wildcraft.webp", description: "Lightweight and spacious bag" },
    { id: 2, name: "Boat Airdopes", value: 20, image: "/images/gifts/boat.jpg", description: "Wireless earbuds with deep bass." },
    { id: 3, name: "Nike Shoes", value: 18, image: "/images/gifts/Nikesh.png", description: "Stylish and durable sports shoes." },
    { id: 4, name: "Fastrack Watch", value: 25, image: "/images/gifts/fastrack.webp", description: " Trendy and casual wristwatch" }
  ];
